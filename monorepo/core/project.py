...
from monorepo.config.loader import ConfigLoader
from monorepo.config.models import MonorepoConfig, ServiceConfig
from monorepo.core.service import Service
...
class MonorepoProject:
    ...
    def __init__(self, path: Path, config: Optional[MonorepoConfig] = None):
    ...
    def _load_config(self) -> MonorepoConfig:
    ...
    def add_service(self, name: str, service_config: ServiceConfig) -> Service:
    ...
    def get_service_dependencies(self, service_name: str) -> List[Service]:
    ...
    def get_service_dependents(self, service_name: str) -> List[Service]:
