...
from monorepo.config.merger import ConfigMerger
from monorepo.config.models import MonorepoConfig
...
class ConfigLoader:
    ...
    def load(self) -> MonorepoConfig:
        ...
        return MonorepoConfig(**main_config)
