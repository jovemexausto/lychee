...
class DevelopmentServer:
    ...
    def __init__(
        ...
        self._monitored_services: Dict[str, Service] = {}
    ...
    async def _start_and_monitor_service(self, service: Service):
        """
    ...
    async def _stop_service(self, service: Service):
        """
    ...
    async def _restart_service_async(self, service: Service):
        """
